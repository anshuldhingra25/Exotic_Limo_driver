...
import com.cabily.cabilydriver.BeginTrip;
import com.cabily.cabilydriver.R;
import com.cabily.cabilydriver.UserInfo;
...
public class ArrivedTrip extends SubclassActivity {
    ...
    public static com.cabily.cabilydriver.ArrivedTrip arrivedTrip_class;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.arrivedtrip);
        arrivedTrip_class = com.cabily.cabilydriver.ArrivedTrip.this;
        initialize();
        initilizeMap();
        //Starting Xmpp service
        ChatingService.startDriverAction(com.cabily.cabilydriver.ArrivedTrip.this);
        Rl_layout_userinfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.cabily.cabilydriver.ArrivedTrip.this, UserInfo.class);
        ...
        Bt_Arrived.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cd = new ConnectionDetector(com.cabily.cabilydriver.ArrivedTrip.this);
        ...
        phone_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Alert(com.cabily.cabilydriver.ArrivedTrip.this.getResources().getString(R.string.alert_sorry_label_title), com.cabily.cabilydriver.ArrivedTrip.this.getResources().getString(R.string.arrived_alert_content1));
                }
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.ArrivedTrip.this);
        gps = new GPSTracker(com.cabily.cabilydriver.ArrivedTrip.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.ArrivedTrip.this);
    ...
    private void initilizeMap() {
        if (googleMap == null) {
            googleMap = ((MapFragment) com.cabily.cabilydriver.ArrivedTrip.this.getFragmentManager().findFragmentById(R.id.arrived_trip_view_map)).getMap();
            if (googleMap == null) {
                Toast.makeText(com.cabily.cabilydriver.ArrivedTrip.this,getResources().getString(R.string.action_alert_unabletocreatemap), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void getRout(LatLng start, LatLng end) {
        ...
        mRequestQueue = Volley.newRequestQueue(com.cabily.cabilydriver.ArrivedTrip.this);
    ...
    private void PostRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.ArrivedTrip.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (Str_status.equalsIgnoreCase("1")) {
                            Intent intent = new Intent(com.cabily.cabilydriver.ArrivedTrip.this, BeginTrip.class);
                            intent.putExtra("user_name", Str_username);
                            intent.putExtra("user_phoneno", Str_user_phoneno);
                            intent.putExtra("user_image", Str_user_img);
                            intent.putExtra("rideid", Str_RideId);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.ArrivedTrip.this, error);
            }
