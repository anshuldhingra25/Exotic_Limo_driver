...
import com.cabily.cabilydriver.PaymentPage;
...
public class OtpPage extends SubclassActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatingService.startDriverAction(com.cabily.cabilydriver.OtpPage.this);

        BT_otp_confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(com.cabily.cabilydriver.OtpPage.this,PaymentPage.class);
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.OtpPage.this);
       ...
       // Et_otp.setSelection(Et_otp.getText().length());
        ...
        cd = new ConnectionDetector(com.cabily.cabilydriver.OtpPage.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.OtpPage.this);
    ...
    private void PostRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.OtpPage.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.OtpPage.this, error);
            }
