...
import com.cabily.cabilydriver.GooglePlaceSearch;
   ...
   // private SimpleDateFormat mFormatter = new SimpleDateFormat("MMM/dd,hh:mm aa");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Et_drop_location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.cabily.cabilydriver.EndTrip_EnterDetails.this, GooglePlaceSearch.class);
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.EndTrip_EnterDetails.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.EndTrip_EnterDetails.this);
    ...
    private void showfaresummerydetails() {
        ...
        final MaterialDialog dialog = new MaterialDialog(com.cabily.cabilydriver.EndTrip_EnterDetails.this);
        View view = LayoutInflater.from(com.cabily.cabilydriver.EndTrip_EnterDetails.this).inflate(R.layout.fare_summery_alert_dialog, null);
        ...
        layout_receive_cash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.cabily.cabilydriver.EndTrip_EnterDetails.this, OtpPage.class);
        ...
        layout_request_payment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cd = new ConnectionDetector(com.cabily.cabilydriver.EndTrip_EnterDetails.this);
                isInternetPresent = cd.isConnectingToInternet();
                if (isInternetPresent) {
    ...
    private void postRequest_EnterTripdetails(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.EndTrip_EnterDetails.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
                    ...
                    try {
                        ...
                        if (Str_status.equalsIgnoreCase("1")){
                            if (Str_need_payment.equalsIgnoreCase("YES")){
                                ...
                                Intent intent= new Intent(com.cabily.cabilydriver.EndTrip_EnterDetails.this,RatingsPage.class);
                                startActivity(intent);
                                overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                dialog.dismiss();
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.EndTrip_EnterDetails.this, error);
            }
        }) {
