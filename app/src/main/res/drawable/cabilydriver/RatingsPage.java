...
public class RatingsPage extends ActivityHockeyApp
{
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.RatingsPage.this);
        ...
        cd = new ConnectionDetector(com.cabily.cabilydriver.RatingsPage.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.RatingsPage.this);
    ...
    private void PostRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.RatingsPage.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (status.equalsIgnoreCase("1")){
                            adapter = new Reviwes_adapter(com.cabily.cabilydriver.RatingsPage.this,reivweslist);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.RatingsPage.this,error);
            }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                      ...
                      try {
                        ...
                        if (status.equalsIgnoreCase("1")) {
                            final MaterialDialog dialog = new MaterialDialog(com.cabily.cabilydriver.RatingsPage.this);
