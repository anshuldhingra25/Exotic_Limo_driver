...
import com.cabily.cabilydriver.RatingsPage;
...
public class PaymentPage extends SubclassActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatingService.startDriverAction(com.cabily.cabilydriver.PaymentPage.this);

        Bt_receivecash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cd = new ConnectionDetector(com.cabily.cabilydriver.PaymentPage.this);
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.PaymentPage.this);
    ...
    private void Alert(String title, String alert) {
        final MaterialDialog dialogs = new MaterialDialog(com.cabily.cabilydriver.PaymentPage.this);
    ...
    private void PostRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.PaymentPage.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Str_status.equalsIgnoreCase("1")){
                                ...
                                final MaterialDialog mdialog = new MaterialDialog(com.cabily.cabilydriver.PaymentPage.this);
                                        ...
                                        .setPositiveButton(
                                                "OK", new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        Intent intent = new Intent(com.cabily.cabilydriver.PaymentPage.this,RatingsPage.class);
                                ...
                                final MaterialDialog alertDialog = new MaterialDialog(com.cabily.cabilydriver.PaymentPage.this);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.PaymentPage.this, error);
