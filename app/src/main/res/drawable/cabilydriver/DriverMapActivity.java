...
public class DriverMapActivity extends ActivityHockeyApp implements View.OnClickListener, com.google.android.gms.location.LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new SessionManager(com.cabily.cabilydriver.DriverMapActivity.this);
        ...
        ChatingService.startDriverAction(com.cabily.cabilydriver.DriverMapActivity.this);
        ...
        Rl_layout_available_status.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.cabily.cabilydriver.DriverMapActivity.this,TripSummaryDetail.class);
    ...
    private void postRequest(final String url) {
        if (myLocation != null) {
            ...
            ServiceManager manager = new ServiceManager(com.cabily.cabilydriver.DriverMapActivity.this, mServiceListener);
            manager.makeServiceRequest(url, Request.Method.POST, jsonParams);
        } else {
          Toast.makeText(com.cabily.cabilydriver.DriverMapActivity.this,"Location Not Update",Toast.LENGTH_SHORT).show();
        }
    }
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(com.cabily.cabilydriver.DriverMapActivity.this,REQUEST_LOCATION);
