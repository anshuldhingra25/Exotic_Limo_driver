...
public class PaymentDetailsList extends ActivityHockeyApp {
    ...
    private void initialize() {
        ...
        session = new SessionManager(com.cabily.cabilydriver.PaymentDetailsList.this);
        ...
        cd = new ConnectionDetector(com.cabily.cabilydriver.PaymentDetailsList.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.PaymentDetailsList.this);
    ...
    private void paymentRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.PaymentDetailsList.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                adapter = new PaymentDetailsListAdapter(com.cabily.cabilydriver.PaymentDetailsList.this, paymentdetailList);
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.PaymentDetailsList.this, error);
            }
        }) {
