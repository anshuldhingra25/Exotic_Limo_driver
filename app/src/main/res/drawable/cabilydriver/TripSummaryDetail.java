...
import com.cabily.cabilydriver.EndTrip_EnterDetails;
...
public class TripSummaryDetail extends SubclassActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bt_Cancel_ride.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(com.cabily.cabilydriver.TripSummaryDetail.this,CancelTrip.class);
        ...
        Bt_Continue_Ride.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Str_continue_ridedetail.equalsIgnoreCase("arrived")){
                    Intent intent = new Intent(com.cabily.cabilydriver.TripSummaryDetail.this,ArrivedTrip.class);
                    ...
                    Intent intent = new Intent(com.cabily.cabilydriver.TripSummaryDetail.this,BeginTrip.class);
                    ...
                    Intent intent = new Intent(com.cabily.cabilydriver.TripSummaryDetail.this,EndTrip_EnterDetails.class);
                    intent.putExtra("user_name", Str_Username);
                    intent.putExtra("user_phoneno", Str_phoneno);
                    intent.putExtra("user_image",Str_userimg);
                    intent.putExtra("rideid",Str_rideId);
                    ...
                    Intent intent = new Intent(com.cabily.cabilydriver.TripSummaryDetail.this,EndTrip.class);
    ...
    private void initialize(){
        session = new SessionManager(com.cabily.cabilydriver.TripSummaryDetail.this);
      ...
      //  Tv_tripdetail_drop = (TextView)findViewById(R.id.tripsummery_detail_view_drop_date);
       ...
       // Rl_layout_drop_details = (RelativeLayout)findViewById(R.id.trip_summery_layout_drop_details);
        ...
        cd = new ConnectionDetector(com.cabily.cabilydriver.TripSummaryDetail.this);
    ...
    private void initilizeMap() {
        if (googleMap == null) {
            googleMap = ((MapFragment) com.cabily.cabilydriver.TripSummaryDetail.this.getFragmentManager().findFragmentById(R.id.tripsummery_view_map)).getMap();
            // check if map is created successfully or not
            if (googleMap == null) {
                Toast.makeText(com.cabily.cabilydriver.TripSummaryDetail.this, "Sorry! unable to create maps", Toast.LENGTH_SHORT).show();
            }
        }
        // Changing map type
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.TripSummaryDetail.this);
    ...
    private void postRequest_tripdetail(String Url)
    {
        ...
        dialog = new Dialog(com.cabily.cabilydriver.TripSummaryDetail.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
            ...
            public void onErrorResponse(VolleyError error) {
                dialog.dismiss();
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.TripSummaryDetail.this, error);
            }
        }) {
