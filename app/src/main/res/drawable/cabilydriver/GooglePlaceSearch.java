...
public class GooglePlaceSearch extends Activity {
        ...
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               Sdrop_location = itemList_location.get(position);
                ...
                cd = new ConnectionDetector(com.cabily.cabilydriver.GooglePlaceSearch.this);
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.GooglePlaceSearch.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.GooglePlaceSearch.this);
    ...
    private void CitySearchRequest(String Url) {
        ...
        postrequest = new StringRequest(Request.Method.GET, Url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                adapter=new PlaceSearchAdapter(com.cabily.cabilydriver.GooglePlaceSearch.this,itemList_location);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                // close keyboard
                CloseKeyboard(Et_search);
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.GooglePlaceSearch.this, error);
            }
        });
    ...
    private void LatLongRequest(String Url) {
        ...
        mdialog = new Dialog(com.cabily.cabilydriver.GooglePlaceSearch.this);
        mdialog.getWindow();
