...
public class ForgotPassword extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rl_layout_email_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cd = new ConnectionDetector(com.cabily.cabilydriver.ForgotPassword.this);
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.ForgotPassword.this);
    ...
    private void forgotpassword_PostRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.ForgotPassword.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.ForgotPassword.this, error);
            }
