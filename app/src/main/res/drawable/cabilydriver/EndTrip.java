...
import com.cabily.cabilydriver.OtpPage;
...
public class EndTrip extends SubclassActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatingService.startDriverAction(com.cabily.cabilydriver.EndTrip.this);

        Bt_End_trip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cd = new ConnectionDetector(com.cabily.cabilydriver.EndTrip.this);
       ...
       Tv_stop_wait.setOnClickListener(new View.OnClickListener() {
        ...
        Bt_Enable_voice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=20.344,34.34&daddr=20.5666,45.345")); startActivity(intent);
            }
        });
    ...
    private void initialize() {
        session = new SessionManager(com.cabily.cabilydriver.EndTrip.this);
        gps = new GPSTracker(com.cabily.cabilydriver.EndTrip.this);
...
*/
    ...
    private void Alert(String title, String message) {
        final PkDialog mDialog = new PkDialog(com.cabily.cabilydriver.EndTrip.this);
    ...
    private void initilizeMap() {
        if (googleMap == null) {
            googleMap = ((MapFragment) com.cabily.cabilydriver.EndTrip.this.getFragmentManager().findFragmentById(R.id.arrived_trip_view_map)).getMap();
            // check if map is created successfully or not
            if (googleMap == null) {
                Toast.makeText(com.cabily.cabilydriver.EndTrip.this, getResources().getString(R.string.action_alert_unabletocreatemap), Toast.LENGTH_SHORT).show();
            }
        }
        // Changing map type
...
*/
    ...
    private void showfaresummerydetails() {
            ...
            final MaterialDialog dialog = new MaterialDialog(com.cabily.cabilydriver.EndTrip.this);
            View view = LayoutInflater.from(com.cabily.cabilydriver.EndTrip.this).inflate(R.layout.fare_summery_alert_dialog, null);
        ...
        layout_receive_cash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.cabily.cabilydriver.EndTrip.this, OtpPage.class);
     ...
     private void PostRequest(String Url) {
        dialog = new Dialog(com.cabily.cabilydriver.EndTrip.this);
        dialog.getWindow();
        ...
        postrequest = new StringRequest(Request.Method.POST, Url,
                       ...
                       try {
                        ...
                        if (Str_status.equalsIgnoreCase("1")){
                            if (Str_need_payment.equalsIgnoreCase("YES")){
                                ...
                                Intent intent= new Intent(com.cabily.cabilydriver.EndTrip.this,RatingsPage.class);
                                startActivity(intent);
                                overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyErrorResponse.VolleyError(com.cabily.cabilydriver.EndTrip.this, error);
            }
